...
class Tx_Showcase_Controller_CategoryController extends Tx_Extbase_MVC_Controller_ActionController {
	 ...
	 *
	 * @param Tx_Showcase_Domain_Model_Category $category the Category to display
	 * @return string The rendered view
	 */
	public function showAction(Tx_Showcase_Domain_Model_Category $category) {
