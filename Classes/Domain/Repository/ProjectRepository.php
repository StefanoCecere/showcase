...
/**
 * Repository for Tx_Showcase_Domain_Model_Project
 *
 * @version $Id$
...
class Tx_Showcase_Domain_Repository_ProjectRepository extends Tx_Extbase_Persistence_Repository {
	/**
	 * find all records regardless of their storage page, enable fields or language
	 *
	 * @param integer $storagePid
	 * @return array <Tx_Showcase_Domain_Model_Project>
	 */
	public function findProjects($storagePid) {
